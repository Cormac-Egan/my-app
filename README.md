This is a [Next.js](https://nextjs.org/) project created with with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app) and [Tailwind] (https://tailwindcss.com/docs/guides/nextjs)
